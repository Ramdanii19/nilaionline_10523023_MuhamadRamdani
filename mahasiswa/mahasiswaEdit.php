    ...
    <form enctype="multipart/form-data" method="post">
      <table width="100%" border="0">
        <tr>
          <td width="27%">Nim</td>
          <td width="4%">:</td>
          <td width="69%"><input type="text" name="nim" size="30" placeholder="NIM" value="<?php echo $dataMhs[0] ?>" readonly="readonly"></td>
        </tr>
        <tr>
          <td>Nama</td>
          <td>:</td>
        ...
        <tr>
          <td>Password</td>
          <td>:</td>
          <td><input type="password" name="password" size="30" placeholder="PASSWORD" value="<?php echo $dataMhs[4] ?>"></td>
        </tr>
        <tr>
